...
import 'package:akdmvisitorsapp/presentaion/more_screen/upcoming_event_item.dart';
...
void main() {
  ...
  group('All upcoming events widget', () {
    Widget upcomingEventItems() {
      return MaterialApp(
    ...
    testWidgets('All upcoming events items widgets and event details', (WidgetTester tester) async {
      await tester.pumpWidget(upcomingEventItems());

      await tester.pump();

      expect(find.byType(UpcomingEventsItem), findsOneWidget);
