...
void main() {
  ...
  final attractionModel =
      AppJsonModel(attractions: <Attraction>[attractionList]);
  group('fromJson', () {
    test('should return a valid model from JSON', () async {
      ...
      // assert
      expect(result.attractions, attractionModel.attractions);
    });
  });
  ...
  group('toJson', () {
    test('should return a JSON map containing proper data', () async {
      ...
      expect(result.attractions![0].toJson(), expectedJsonMap["attractions"]![0]);
    });
  });
}
